...
const CONFIG = {
  ...
  steps: [
    { num: "01", active: true,
      ...
      desc:  { id: "Riset kompetitor, keyword ASO, dan tingkat kompetisi sebelum development dimulai.",
    ...
    { num: "02", active: false,
      ...
      desc:  { id: "Dikerjakan tim developer & AI agent, mengikuti pola dan best practice yang sudah teruji.",
               en: "Built by our developer team & AI agents, following proven patterns and best practices." } },
    { num: "03", active: false,
      title: { id: "Testing / QA",        en: "Testing / QA"         },
      desc:  { id: "APK diuji menyeluruh — performa, stabilitas iklan, dan pengalaman pengguna — sebelum rilis.",
               en: "APK thoroughly tested — performance, ad stability, and user experience — before release." } },
    { num: "04", active: false,
      title: { id: "Published",           en: "Published"            },
      desc:  { id: "Live di Google Play Store, lengkap dengan privacy policy dan listing yang dioptimasi.",
    ...
    { num: "05", active: false,
      ...
      desc:  { id: "Pantau performa, update rutin, dan optimasi monetisasi iklan secara berkelanjutan.",
    ...
    points: [
      {
        ...
        desc:  { id: "Kami memburu celah pasar yang kompetitornya masih kecil dan terfragmentasi — bukan bersaing head-to-head dengan raksasa global.",
      ...
      },
      {
        ...
        desc:  { id: "4 akun developer memisahkan risiko dan mempermudah cross-promotion antar app dalam kategori yang sama.",
      ...
      },
      {
        ...
        desc:  { id: "Setiap app diarahkan ke pasar spesifik — Indonesia, Global, US, Australia, atau Malaysia — sesuai potensi CPM & demand.",
      ...
      },
      {
        ...
        desc:  { id: "Development cepat dengan checklist ASO, privacy policy, dan QA yang konsisten di setiap app.",
  ...
  footer: {
    ...
    links: [
      ...
      { label: { id: "Privacy Policy", en: "Privacy Policy"  }, href: "/privacy-policy.html" },
    ],
  },
